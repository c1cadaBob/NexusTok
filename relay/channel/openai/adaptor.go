...
import (
	...
	"github.com/c1cadaBob/NexusTok/relay/channel/ai360"
	"github.com/c1cadaBob/NexusTok/relay/channel/lingyiwanwu"
	"github.com/c1cadaBob/NexusTok/relay/channel/openrouter"
	"github.com/c1cadaBob/NexusTok/relaykit/dto"

	//"github.com/c1cadaBob/NexusTok/relay/channel/minimax"
	"github.com/c1cadaBob/NexusTok/relay/channel/xinference"
	relaycommon "github.com/c1cadaBob/NexusTok/relay/common"
	"github.com/c1cadaBob/NexusTok/relay/common_handler"
	relayconstant "github.com/c1cadaBob/NexusTok/relay/constant"
	kitreasoning "github.com/c1cadaBob/NexusTok/relaykit/relayconvert/reasoning"
	"github.com/c1cadaBob/NexusTok/relaykit/types"
	"github.com/c1cadaBob/NexusTok/service"
	"github.com/c1cadaBob/NexusTok/setting/model_setting"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		if header.Get("HTTP-Referer") == "" {
			header.Set("HTTP-Referer", "https://www.nexustok.ai")
		}
