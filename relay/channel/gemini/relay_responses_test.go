...
func TestGeminiResponsesHandlerReturnsOpenAIResponsesJSON(t *testing.T) {
	...
	usage, relayErr := GeminiResponsesHandler(c, info, &http.Response{
...
func TestGeminiResponsesHandlerClosesBodyOnReadError(t *testing.T) {
	...
	usage, relayErr := GeminiResponsesHandler(c, newGeminiResponsesRelayInfo(false), &http.Response{Body: body})
...
func TestGeminiResponsesStreamHandlerReturnsOpenAIResponsesSSE(t *testing.T) {
	...
	usage, relayErr := GeminiResponsesStreamHandler(c, info, &http.Response{
