...
import { KeySwitchingSection } from './key-switching-section'
      ...
      <GlobalSettingsCard
        defaultValues={{
          global: {
            ...
            endpoint_auto_conversion_enabled:
              settings['global.endpoint_auto_conversion_enabled'],
    ...
    build: (settings: ModelSettings) => (
      <RoutingReliabilitySection
        defaultValues={{
          ...
          RoutingStrategyMode: settings.RoutingStrategyMode,
