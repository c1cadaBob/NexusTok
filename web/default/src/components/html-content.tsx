...
// hardenIsolatedHtml 对 DOMPurify 结果做二次加固，补齐浏览器行为相关的不变量。
...
// sanitizeHtmlContent 是显式 HTML 内容进入 React 渲染前的唯一清洗入口。
...
export function HtmlContent(props: HtmlContentProps) {
  ...
  return (
    <div
      ...
      // HTML 已在上方通过 DOMPurify 清洗，并由 hardenIsolatedHtml 处理危险浏览器行为。
