...
import (
	...
	taskdto "github.com/c1cadaBob/NexusTok/dto"
...
func processChannelError(c *gin.Context, channelError types.ChannelError, err *types.NewAPIError, relayInfo *relaycommon.RelayInfo) {
	if routingKeyID := common.GetContextKeyInt(c, constant.ContextKeyRoutingKeyId); routingKeyID > 0 {
		channelError.RoutingKeyID = uint(routingKeyID)
		channelError.KeySource = common.GetContextKeyString(c, constant.ContextKeyRoutingKeySource)
	}
