...
var auditContentTemplates = map[string]string{
	...
	"channel.upstream_site_create":       "Created upstream platform site ${platform} (ID: ${id})",
	"channel.upstream_site_update":       "Updated upstream platform site ${platform} (ID: ${id})",
	"channel.upstream_sync":              "Synchronized upstream platform site (ID: ${channel_id})",
	"channel.upstream_key_update":        "Updated upstream key settings (channel ID: ${channel_id}, key ID: ${key_id})",
	"channel.upstream_key_status_update": "Updated upstream key status (channel ID: ${channel_id}, count: ${count})",
