...
var auditContentTemplates = map[string]string{
	...
	"channel.upstream_account_sync_refresh":         "Refreshed upstream account sync for channel ${name} (ID: ${id})",
	...
	"system_task.upstream_account_sync":             "Ran upstream account sync system task ${task_id}",
	"system_task.upstream_account_schedule_refresh": "Refreshed upstream account scheduling suggestions ${task_id}",
}
