...
func TestRegisterSystemSettingRoutesKeepsCoreHandlers(t *testing.T) {
	...
	assertRouteHandler(t, engine, http.MethodGet, "/api/option/waffo-pancake/catalog", controller.ListWaffoPancakeCatalog)
	assertRouteHandler(t, engine, http.MethodPost, "/api/option/waffo-pancake/catalog", controller.ListWaffoPancakeCatalog)
	assertRouteHandler(t, engine, http.MethodPost, "/api/option/waffo-pancake/pair", controller.CreateWaffoPancakePair)
	assertRouteHandler(t, engine, http.MethodPost, "/api/option/waffo-pancake/subscription-product", controller.CreateWaffoPancakeSubscriptionProduct)
	assertRouteHandler(t, engine, http.MethodGet, "/api/option/waffo-pancake/subscription-product-options", controller.ListWaffoPancakeSubscriptionProductOptions)
...
func TestSystemSettingPermissionRoutesClassifyCoreActions(t *testing.T) {
	...
	assertSystemSettingPermissionRoute(t, optionPermissionRoutes, http.MethodGet, "/waffo-pancake/catalog", authz.SystemSettingRead)
	assertSystemSettingPermissionRoute(t, optionPermissionRoutes, http.MethodPost, "/waffo-pancake/catalog", authz.SystemSettingOperate)
	assertSystemSettingPermissionRoute(t, optionPermissionRoutes, http.MethodPost, "/waffo-pancake/pair", authz.SystemSettingSensitiveWrite)
	assertSystemSettingPermissionRoute(t, optionPermissionRoutes, http.MethodPost, "/waffo-pancake/subscription-product", authz.SystemSettingSensitiveWrite)
	assertSystemSettingPermissionRoute(t, optionPermissionRoutes, http.MethodGet, "/waffo-pancake/subscription-product-options", authz.SystemSettingRead)
