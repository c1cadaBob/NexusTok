...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		{
			accountPoolRoute.GET("/providers", controller.ListAccountPoolProviders)
			...
			accountPoolRoute.POST("/groups/:id/oauth/:provider/start", controller.StartAccountPoolProviderOAuth)
			accountPoolRoute.POST("/groups/:id/oauth/:provider/complete", controller.CompleteAccountPoolProviderOAuth)
			accountPoolRoute.POST("/groups/:id/device/:provider/start", controller.StartAccountPoolProviderDevice)
			...
			accountPoolRoute.GET("/login-sessions/:session_id", controller.GetAccountPoolLoginSession)
			accountPoolRoute.POST("/login-sessions/:session_id/cancel", controller.CancelAccountPoolLoginSession)
			...
			accountPoolRoute.POST("/accounts/:account_id/runtime/reset", controller.ResetPoolAccountRuntime)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/accounts", controller.CreateChannelAccount)
			channelRoute.POST("/:id/accounts/batch", controller.BatchCreateChannelAccounts)
			channelRoute.POST("/:id/accounts/import-multikey", controller.ImportMultiKeyToChannelAccounts)
			channelRoute.GET("/:id/accounts/:account_id", controller.GetChannelAccount)
			channelRoute.PUT("/:id/accounts/:account_id", controller.UpdateChannelAccount)
			channelRoute.DELETE("/:id/accounts/:account_id", controller.DeleteChannelAccount)
			channelRoute.POST("/:id/accounts/:account_id/status", controller.UpdateChannelAccountStatus)
