...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/upstream-resources", permission: authz.ChannelRead, handler: controller.GetPlatformSiteResources},
	...
	{method: http.MethodPost, path: "/:id/upstream-resources/sync", permission: authz.ChannelOperate, handler: controller.SyncPlatformSiteResources},
