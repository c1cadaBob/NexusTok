...
func TestRegisterChannelRoutesKeepsCoreHandlers(t *testing.T) {
	...
	assertRouteHandler(t, engine, http.MethodPost, "/api/channel/upstream-account/preview/:preview_id/key-models", controller.FetchUpstreamPreviewKeyModels)
...
func TestChannelPermissionRoutesClassifyCoreActions(t *testing.T) {
	...
	assertPermissionRoute(t, http.MethodPost, "/upstream-account/preview/:preview_id/key-models", authz.ChannelSensitiveWrite)
