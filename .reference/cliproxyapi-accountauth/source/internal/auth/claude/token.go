...
// ClaudeTokenStorage 存储 Anthropic Claude API 认证的 OAuth2 令牌信息。
// 维护与现有认证系统的兼容性，同时添加 Claude 特定的字段，
...
type ClaudeTokenStorage struct {
	...
	// Email 是与此令牌关联的 Anthropic 账户电子邮件地址
	Email string `json:"email"`

	// Type 表示认证提供商类型，此存储始终为 "claude"
...
// SaveTokenToFile 将 Claude 令牌存储序列化为 JSON 文件。
