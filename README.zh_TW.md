...
### 📖 [官方文件](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/c1cada/NexusTok)
...
- 📱 Telegram 授權登錄
- 🔑 OIDC 統一認證
- 🔍 Key 查詢使用額度（配合 [nexustok-key-tool](https://github.com/c1cada/nexustok-key-tool)）
...
> [!TIP]
> **最新版 Docker 鏡像：** `c1cada/nexustok:latest`
...
| 項目 | 說明 |
|------|------|
| [nexustok-key-tool](https://github.com/c1cada/nexustok-key-tool) | Key 額度查詢工具 |
| [nexustok-horizon](https://github.com/c1cada/nexustok-horizon) | NexusTok 高性能優化版 |
...
如果您所在的組織政策不允許使用 AGPLv3 許可的軟體，或您希望規避 AGPLv3 的開源義務，請發送郵件至：[support@c1cada.dev](mailto:support@c1cada.dev)
...
**[官方文件](https://docs.newapi.pro/zh/docs)** • **[問題回饋](https://github.com/c1cada/NexusTok/issues)** • **[最新發布](https://github.com/c1cada/NexusTok/releases)**
